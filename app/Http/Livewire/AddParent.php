...
class AddParent extends Component
{
    ...
    public function updated($propertyName)
    {
        $this->validateOnly($propertyName, [
            ...
            'National_ID_Father' => 'required|string|min:5|max:15|regex:/[0-9]{9}/',
            'Passport_ID_Father' => 'min:5|max:15',
            'Phone_Father' => 'min:5|regex:/^([0-9\s\-\+\(\)]*)$/',
            'National_ID_Mother' => 'required|string|min:5|max:15|regex:/[0-9]{9}/',
            'Passport_ID_Mother' => 'min:5|max:15',
            'Phone_Mother' => 'min:5|regex:/^([0-9\s\-\+\(\)]*)$/'
        ]);
    }
    ...
    public function firstStepSubmit()
    {
       $this->validate([
            ...
            'Phone_Father' => 'required|min:5|regex:/^([0-9\s\-\+\(\)]*)$/',
    ...
    public function submitForm_edit(){
        ...
        if ($this->Parent_id){
            ...
            $parent->update([
                ...
                'Job_Mother'=>$this->Job_Mother = ['en' => $this->Job_Mother_en, 'ar' => $this->Job_Mother],
