                    ...
                    <form action="{{route('Fees.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                ...
                                <select class="custom-select mr-sm-1" name="Grade_id">
                            ...
                            <div class="form-group col">
                                <label for="inputZip">Fee_type </label>
                                <select class="custom-select mr-sm-1" name="Fee_type">
