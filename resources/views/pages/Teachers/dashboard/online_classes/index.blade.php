                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($online_classes as $online_classe)
                                            ...
                                            <td>{{$online_classe->section->Name_Section}}</td>
                                                ...
                                                <td class="text-danger"><a data-toggle="modal" data-target="#start_receipt{{$online_classe->id}}" href="">{{ __('My_Classes_trans.Start_online_class') }}</a></td>
                                                <td>
                                        ...
                                        @include('pages.Teachers.dashboard.online_classes.join')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
