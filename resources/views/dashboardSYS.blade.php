                                    ...
                                    <div class="tab-pane fade active show" id="students" role="tabpanel" aria-labelledby="students-tab">
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                <tbody>
                                                @forelse(\App\Models\Student::with('gender','grade','classroom','section')->latest()->take(10)->get() as $student)
                                                    <tr>
                                    ...
                                    <div class="tab-pane fade" id="teachers" role="tabpanel" aria-labelledby="teachers-tab">
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                @forelse(\App\Models\Teacher::with('genders','specializations')->latest()->take(10)->get() as $teacher)
                                                    <tbody>
                                                    <tr>
                                                        <td>{{$loop->iteration}}</td>
                                                        <td>{{$teacher->Name}}</td>
                                    ...
                                    <div class="tab-pane fade" id="parents" role="tabpanel" aria-labelledby="parents-tab">
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                <tbody>
                                                @forelse(\App\Models\My_Parent::latest()->take(15)->get() as $parent)
                                                    <tr>
                                                        <td>{{$loop->iteration}}</td>
                                    ...
                                    <div class="tab-pane fade" id="fee_invoices" role="tabpanel" aria-labelledby="fee_invoices-tab">
                                        <div class="table-responsive mt-15">
                                            <table style="text-align: center" class="table center-aligned-table table-hover mb-0">
                                                ...
                                                <tbody>
                                                @forelse(\App\Models\Fee_invoice::with('fees','classroom','student','grade','section')->latest()->take(10)->get() as $section)
                                                    <tr>
                                                        <td>{{$loop->iteration}}</td>
